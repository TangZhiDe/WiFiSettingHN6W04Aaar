...
public class PermissionUtils {
    private static final String TAG = "wifi-AP";
    ...
    public static final int CODE_WRITE_SETTINGS = 9;//add by xy 2018
    ...
    public static final String WRITE_SETTINGS = Manifest.permission.WRITE_SETTINGS;//add bu xy 2018 09 27
...
//                    .show();
        ...
        if (checkSelfPermission != PackageManager.PERMISSION_GRANTED) {
            ...
            Log.e(TAG, "ActivityCompat.checkSelfPermission");
